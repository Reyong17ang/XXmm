    ...
    override fun onReceive(context: Context, intent: Intent) {
        when (intent.action) {
            WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION -> {
                ...
                LogUtils.d("WIFI_P2P_STATE_CHANGED_ACTION： $enabled")
            }

            WifiP2pManager.WIFI_P2P_PEERS_CHANGED_ACTION -> {
                LogUtils.d("WIFI_P2P_PEERS_CHANGED_ACTION")
            ...
            WifiP2pManager.WIFI_P2P_CONNECTION_CHANGED_ACTION -> {
                ...
                LogUtils.d("WIFI_P2P_CONNECTION_CHANGED_ACTION ： " + networkInfo?.isConnected)
                ...
                if (networkInfo != null && networkInfo.isConnected) {
                    ...
                    LogUtils.d("已连接 P2P 设备")
                } else {
                    directActionListener.onDisconnection()
                    LogUtils.d("与 P2P 设备已断开连接")
                }
            }
            ...
            WifiP2pManager.WIFI_P2P_THIS_DEVICE_CHANGED_ACTION -> {
                ...
                LogUtils.d("WIFI_P2P_THIS_DEVICE_CHANGED_ACTION ： ${wifiP2pDevice.toString()}")
            }
        }
    }
