package com.example.lib_net.netty.udp
...
import com.example.lib_net.netty.handlers.DatagramDataToPckAddrDataDecoder
import com.example.lib_net.netty.handlers.PckAddrDataToDatagramDataEncoder
    ...
    override fun runTask() {
        ...
        try {
            ...
            val channel = when (connectionType) {
                is ConnectionType.Bind -> bootStrap.bind(
                    InetSocketAddress(
                ...
                is ConnectionType.Connect -> bootStrap.connect(
                    InetSocketAddress(
                        connectionType.address,
                        connectionType.port
                    )
