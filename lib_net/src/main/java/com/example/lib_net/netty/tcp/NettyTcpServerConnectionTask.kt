package com.example.lib_net.netty.tcp
...
import com.example.lib_net.netty.PackageDataWithAddress
import com.example.lib_net.netty.handlers.BytesToPackageDataDecoder
import com.example.lib_net.netty.handlers.CheckerHandler
import com.example.lib_net.netty.handlers.PackageDataToBytesEncoder
...
class NettyTcpServerConnectionTask(
    ...
    inner class ChildConnectionTask(private val socketChannel: NioSocketChannel) :
        ...
        override val state: AtomicReference<NettyTaskState> =
            AtomicReference(NettyTaskState.NotExecute)
