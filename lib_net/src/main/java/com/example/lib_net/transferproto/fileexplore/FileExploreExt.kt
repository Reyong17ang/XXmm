...
suspend fun FileExplore.requestScanDirSuspend(dirPath: String) =
    suspendCancellableCoroutine<ScanDirResp> { cont ->
...
suspend fun FileExplore.requestSendFilesSuspend(
    sendFiles: List<FileExploreFile>,
    maxConnection: Int = 8
...
suspend fun FileExplore.requestDownloadFilesSuspend(
    downloadFiles: List<FileExploreFile>,
